...
namespace Mathscals
{
    class DifficultyLvl2
    {
        public static void Lvl2(string ops)
        {
            Console.WriteLine("You selected Dificultylvl 2");
            ...
            {
                Console.WriteLine("{0} is outside the range.", Console.ReadLine());
            }
            ...
            {
                Random q = new Random();
                int qNumQ = q.Next(10, 100);
                int qNumQ2 = q.Next(10, 100);
                int answer = 0;
